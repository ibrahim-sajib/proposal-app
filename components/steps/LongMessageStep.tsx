    ...
    <div className="relative flex min-h-dvh w-full items-center justify-center px-6 py-12">
      ...
      >
        <p className="font-display text-lg sm:text-xl md:text-2xl font-light leading-relaxed text-white drop-shadow-[0_2px_10px_rgba(0,0,0,0.5)]">
          Marrying you was the best decision I have ever made. You&apos;re not only the love of my life, but also my
          best friend, my greatest comfort, and the place my heart will always call home. I know we&apos;ve already
          created countless beautiful memories together, but I believe our best ones are still waiting for us. So...
          let&apos;s make another unforgettable memory, just you and me.
        </p>
